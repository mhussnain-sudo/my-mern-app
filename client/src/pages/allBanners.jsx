...
import { useEffect, useState } from 'react'; import {
    getheaders } from '../apis/userApi'; // Adjust the path as needed
    
    const baseurl = "http://localhost:3000";
    
    export default function AllBanners() { const [headers, setHeaders] = useState([]); const [error, setError] = useState("");
