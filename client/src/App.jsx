...
import AllPigeonOwners from './pages/allPigeonOwners';
    ...
    return (
        <div className='flex flex-col px-4 gap-3'>
            <Routes>
                ...
                <Route path="/all-PigeonsOwners" element={user && user.role === "admin" ? <AdminLayout><AllPigeonOwners /></AdminLayout> : <Navigate to="/" />} />
                <Route path="/create-PigeonsOwners" element={user && user.role === "admin" ? <AdminLayout><CreatePigeonOwners /></AdminLayout> : <Navigate to="/" />} />
