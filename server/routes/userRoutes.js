...
const { uploadMultiple, uploadAvatar,uploadtournamentImage, uploadPigeonAvatar } = require('../middlewares/multerMiddleware.js');
...
routes.get("/all-Members", controller.getAllMembers);
...
routes.post("/add-members", verifyToken, verifyAdmin, uploadAvatar, controller.addMember);
